...
st.write("Enter patient's Detail below: ")
...
education = st.selectbox("Education Level", [1, 2, 3, 4], help = '1 = Primary School, 2 = High School, 3 = Graduation, 4 = Post Graduation')
CurrentSmoker = st.selectbox('Current Smoker', [0, 1])
cigsPerDay = st.number_input('Cigarette Per Day', min_value=0, max_value=100,value=0)
...
if st.button('Predict'):
    ...
    if prediction[0] == 1:
        st.error("High risk of Corornary Heart Disease")
        #st.snow()
    else:
